...
const notifySchema = new mongoose.Schema({
    ...
    notifications: {
        likesNotification: [{ post_id: { type: String },post_type:{ type: String}, body: { type: String }, Profile_pic: { type: String },verificationStatus:{type : String}, Full_name: { type: String },user_id:{type : String} , User_name:{type : String},date_added: {
            type: String,
            //default: moment().tz("Asia/Calcutta").format("YYYY-MM-DD HH:mm:ss")
        },Media:{type:String} }],
        commentNotification: [{ post_id: { type: String },post_type:{ type: String}, body: { type: String }, Profile_pic: { type: String },verificationStatus:{type : String}, Full_name: { type: String },user_id:{type : String} , User_name:{type : String} , comment_id : {type: String},date_added: {
            type: String,
            //default: moment().tz("Asia/Calcutta").format("YYYY-MM-DD HH:mm:ss")
        },Media:{type:String}}],
